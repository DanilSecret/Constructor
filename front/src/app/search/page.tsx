    ...
    return (
        <div className="min-h-screen bg-[#F5F7FA] flex flex-col text-black">
            ...
            <div className="flex-1 flex justify-center items-stretch py-10 px-4">
                <div
                    className="w-full max-w-screen-xl p-9 rounded-[10px] shadow-md bg-white border border-[#D5D8DC] flex flex-col flex-grow min-h-[calc(95vh-120px)]"
                ...
                >
                    ...
                    <div className="flex justify-between items-center max-w-[900px] w-full mb-4 mx-auto">
                        <input
                            type="text"
                    ...
                    <div className="flex justify-center w-full px-4 overflow-x-auto">
                        <table
                            className="bg-white rounded shadow border border-[#D5D8DC] max-w-[900px] w-full min-w-[650px]"
                        >
                            <thead>
                            ...
                            {students.length > 0 ? (
                                students.map((student, index) => (
                                    <tr key={student.uuid} className="text-sm hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-2 border-b flex justify-center gap-x-2">
                                            <button
